...
for i in range(0,len(filenames_energy)):
        ...
        desc = ocv.read_xml_file(folder_data_train+filenames_desc[i], "Descriptors")
        ...
        edge_list, edge_features = SuperpixelAdjacency.convertToAdjacencyListPotts(nbrs, segments,label_list)
        #edge_features.shape=len(edge_features),1
        x = (energy, edge_list,edge_features)
...
x_temp=(desc_temp, edge_list,edge_features)
X_train.append(x_temp);
gt_temp =np.zeros((len(desc),)) +9
Y_train.append(np.asarray(gt_temp,'int64'))


#Save Data
print "Saving Data"
cPickle.dump((X_train,Y_train),open("/home/prassanna/Development/workspace/CamVid_scripts/FrameworkDump3/model/crf_data_200.pkl","w"))
...
cPickle.dump(ssvm, open("/home/prassanna/Development/workspace/CamVid_scripts/FrameworkDump3/model/trained_crf.pkl", "w"))
